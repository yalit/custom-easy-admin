...
class PublishPostActionTest extends AbstractAppCrudTestCase
{
    public function testPublishPost(): void
    {
        ...
        $url = $urlGenerator->setRoute(PostPublishController::CRUD_ROUTE_NAME, ['id' => $post->getId()])->generateUrl();
        ...
        self::assertSelectorTextContains($postColumnStatusSelector, $translator->trans(PostStatus::PUBLISHED->value));
    }
